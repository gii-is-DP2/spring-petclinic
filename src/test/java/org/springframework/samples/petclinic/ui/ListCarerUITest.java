...
public class ListCarerUITest {
	...
	public void testListCarerUI() throws Exception {
		whenLoggedInAs("admin", "admin")
		.thenIClickCarerList()
		.thenIAmShownAllCarers();

	}

	private ListCarerUITest whenLoggedInAs(String username, String password) {
		driver.get(baseUrl);
	...
	private ListCarerUITest thenIClickCarerList() {
	...
	private ListCarerUITest thenIAmShownAllCarers() {
		try {
