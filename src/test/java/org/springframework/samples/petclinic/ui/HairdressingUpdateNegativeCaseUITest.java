...
public class HairdressingUpdateNegativeCaseUITest {
	...
	@Test
	  public void testUpdateHairdressingNegativeCase() throws Exception {
	    driver.get(baseUrl);
...
//	    driver.findElement(By.id("password")).sendKeys(Keys.ENTER);
	    ...
	    driver.findElement(By.id("date")).sendKeys("2015/02/02");
	    ...
	    driver.findElement(By.xpath("//button[@type='submit']")).click();
	    assertEquals("Please, select a future date", driver.findElement(By.xpath("//form[@id='add-hairdressing-form']/div/div/div/span[2]")).getText());
	  }
